...
export function EmptySideMenu() {
  ...
  return (
    <aside className="side-menu border-lines-light -mt-px flex flex-col items-center justify-center gap-4 border-r p-6 md:bg-white lg:w-[288px] lg:border-r-2 lg:bg-white">
